...
def main():
    ...
    if callback_url:
        ...
        if "code=" in callback_url:
            ...
            print("\nNEXT STEPS:")
            print("-" * 40)
            print("1. Verify the redirect URI above matches EXACTLY what's in eBay Developer Account")
            ...
            print("4. If still failing, check eBay Developer Account for the RuName configuration")
        else:
