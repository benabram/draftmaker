...
class TestOrchestrator:
    ...
    async def test_process_single_upc_success(self, orchestrator):
        ...
        result = await orchestrator.process_single_upc("123456789012", create_draft=True)
    ...
    async def test_process_single_upc_no_metadata(self, orchestrator):
        ...
        result = await orchestrator.process_single_upc("000000000000", create_draft=True)
    ...
    async def test_process_single_upc_test_mode(self, orchestrator):
        ...
        result = await orchestrator.process_single_upc("123456789012", create_draft=False)
    ...
    async def test_process_batch_gcs_success(self, orchestrator):
        ...
        with patch.object(orchestrator, 'process_single_upc', new_callable=AsyncMock) as mock_process:
        ...
        orchestrator.upc_processor.load_upcs_from_gcs.assert_called_with("test-bucket", "upcs.txt")
    ...
    async def test_process_batch_local_file(self, orchestrator):
        ...
        orchestrator.upc_processor.load_upcs_from_local_txt.assert_called_with("data/test.txt")
