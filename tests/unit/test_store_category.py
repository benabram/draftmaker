...
def test_offer_includes_store_category():
    ...
    # Assertions
    assert (
        "storeCategoryNames" in offer
    ), "storeCategoryNames field is missing from offer payload"
    assert isinstance(
        offer["storeCategoryNames"], list
    ), "storeCategoryNames should be a list"
    assert offer["storeCategoryNames"] == [
        "CD"
    ], "storeCategoryNames should contain 'CD'"
    ...
    print(
        "✅ All assertions passed: Store category 'CD' is properly included in offer payload"
    )
...
def test_offer_payload_structure():
        ...
        json.dumps(
            {
                ...
                "pricingSummary": {
                    ...
                    "bestOfferEnabled": offer.get("pricingSummary", {}).get(
                        "bestOfferEnabled"
                    ),
                },
            },
    ...
    assert offer["storeCategoryNames"] == [
        "CD"
    ], "Store category 'CD' should be included in every offer"
